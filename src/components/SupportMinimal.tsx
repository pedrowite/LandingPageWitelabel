  ...
  return (
    <section className="relative py-24 px-6 overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* Phone Interativo - Mobile Version (abaixo do subtítulo) */}
        <motion.div
          initial={{ opacity: 0, scale: 0.9 }}
          whileInView={{ opacity: 1, scale: 1 }}
          viewport={{ once: true }}
          transition={{ duration: 0.8 }}
          className="relative flex justify-center mb-16 lg:hidden"
        >
          {/* Background Glow */}
          <motion.div
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.8 }}
            className="relative hidden lg:flex justify-center lg:justify-center order-2 lg:order-2"
          >
            {/* Background Glow */}
            <motion.div
              className="absolute inset-0 -z-10"
